...
namespace StatisticsAnalysisTool.Avalonia.Common
{
    public static class CategoryController
    {
        ...
        {
            return SubCategoryNames.TryGetValue(shopSubCategory, out var name) ? name : string.Empty;
        }

        public static string GetCategoryName(ShopCategory shopCategory)
        {
            return CategoryNames.TryGetValue(shopCategory, out var name) ? name : string.Empty;
        }

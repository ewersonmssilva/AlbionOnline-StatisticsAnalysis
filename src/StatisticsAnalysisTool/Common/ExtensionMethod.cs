...
public static class ExtensionMethod
{
    ...
    public static double GetDamagePercentage(this List<KeyValuePair<Guid, PlayerGameObject>> playerObjects,
        double playerDamage)
    {
    ...
    public static double GetHealPercentage(this List<KeyValuePair<Guid, PlayerGameObject>> playerObjects,
        double playerHeal)
    {
    ...
    public static byte[] ToByteArray(this object value)
    {
        ...
        return valueType.IsArray switch
        {
            true when typeof(byte[]).Name == valueType.Name => (byte[]) value,
            true when typeof(short[]).Name == valueType.Name => Array.ConvertAll((short[]) value, b => (byte) b),
            true when typeof(int[]).Name == valueType.Name => Array.ConvertAll((int[]) value, b => (byte) b),
            true when typeof(long[]).Name == valueType.Name => Array.ConvertAll((long[]) value, b => (byte) b),
            _ => Array.Empty<byte>()
        };
    }

    public static short[] ToShortArray(this object value)
    {
        var valueType = value.GetType();
        return valueType.IsArray switch
        {
            true when typeof(byte[]).Name == valueType.Name => Array.ConvertAll((byte[]) value, b => (short) b),
            true when typeof(short[]).Name == valueType.Name => (short[])value,
            true when typeof(int[]).Name == valueType.Name => Array.ConvertAll((int[]) value, b => (short) b),
            true when typeof(long[]).Name == valueType.Name => Array.ConvertAll((long[]) value, b => (short) b),
            _ => Array.Empty<short>()
        };
    }
    ...
    public static int[] ToIntArray(this object value)
    {
        ...
        return valueType.IsArray switch
        {
            true when typeof(byte[]).Name == valueType.Name => Array.ConvertAll((byte[]) value, b => (int) b),
            true when typeof(short[]).Name == valueType.Name => Array.ConvertAll((short[]) value, b => (int) b),
            true when typeof(int[]).Name == valueType.Name => (int[])value,
            true when typeof(long[]).Name == valueType.Name => Array.ConvertAll((long[]) value, b => (int) b),
            _ => Array.Empty<int>()
        };
    }

    public static long[] ToLongArray(this object value)
    {
        var valueType = value.GetType();
        return valueType.IsArray switch
        {
            true when typeof(byte[]).Name == valueType.Name => Array.ConvertAll((byte[]) value, b => (long) b),
            true when typeof(short[]).Name == valueType.Name => Array.ConvertAll((short[]) value, b => (long) b),
            true when typeof(int[]).Name == valueType.Name => Array.ConvertAll((int[]) value, b => (long) b),
            true when typeof(long[]).Name == valueType.Name => (long[])value,
            _ => Array.Empty<long>()
        };
    }
